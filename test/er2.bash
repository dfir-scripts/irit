...
mount_image() {
    ...
    if command -v pvscan >/dev/null 2>&1; then
        ...
        if [ -n "$vgs_found" ]; then
            ...
            if [ -n "$ewf_mount" ] || [ -n "$aff_mount" ] || [ -n "$splitraw_mount" ]; then
                # E01/AFF/001 images - FUSE-protected, cannot be modified
                echo ""
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "ℹ️  INFO: LVM Activation on Read-Only Forensic Container"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo ""
                echo "This forensic image (E01/AFF/001) is mounted via FUSE with read-only protection."
                echo ""
                echo "PROTECTION MECHANISM:"
                echo "  • ewfmount/affuse enforces read-only access (cannot be bypassed)"
                echo "  • All write attempts are blocked at the FUSE layer"
                echo "  • The original forensic container file is fully protected"
                echo "  • The E01/AFF/001 file hash will NOT change"
                echo ""
                echo "LVM ACTIVATION BEHAVIOR:"
                echo "  • LVM will attempt to write metadata (activation state, timestamps)"
                echo "  • Writes may succeed to in-memory overlay OR fail silently"
                echo "  • Logical volumes may or may not become available"
                echo "  • The underlying forensic container remains unchanged"
                echo ""
                echo "FORENSIC IMPACT:"
                echo "  • Original evidence integrity is preserved"
                echo "  • Container file hash remains unchanged"
                echo "  • Chain of custody is maintained"
                echo ""
                echo "NOTE: If LVM activation fails due to read-only restrictions,"
                echo "      you must extract the image to raw format first:"
                echo "      ewfmount image.E01 /mnt/ewf && dd if=/mnt/ewf/ewf1 of=image.raw"
                echo ""
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo ""
